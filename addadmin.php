...
<body>
    <header id="header"><!--header-->
            ...
            <section>
               ...
               <div class="container">    
                    <div class="features_items"><!--features_items-->
                        <h2 class="title text-center">Input Data Admin</h2>
                        <div class="col-sm-15">
                <div class="jumbotron">
        ...
        <table width="50%" border="0">
                  ...
                  <button type="submit" class="btn btn-primary">Submit</button><p></p>

                   <a class="btn btn-info" style="width:176px" href="dataadmin.php">Back</a>
                </form>
