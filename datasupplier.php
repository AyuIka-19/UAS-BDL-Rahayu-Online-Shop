		...
		<section>
			<div class="admin">
                ...
                <a href="data.php"><button class="btn btn-primary btn-lg">Home</button></a> <br><br>
                            <a href="addsupplier.php"><button class="btn btn-dark btn-lg">Tambah Data</button></a> 
</div>
                        
                        <div class="search">
                        <form action="datasupplier.php" method="get" autocomplete="on">
                        <div class="row">
                        <div class="col-lg-4 col-lg-offset-4">
                        <div class="input-group">
                        <input type="text" name="supplier"  placeholder="Search..." class="form-control" /> 
			...
			<div class="row">	
				<div class="col-sm-12 padding-right">
					<div class="features_items">
						<h2 class="title text-center">Data Supplier</h2>
                    ...
                    if(isset($results)){
                      foreach($results as $r){
                        ...
                        <tr>
                            ...
                            <td><a href="hapussupplier.php?id=<?= $r["_id"]?>" class="btn btn-danger" onclick="
                                return confirm('Anda yakin untuk hapus data supplier?');" >Hapus</a>
                        </tr>
                        <?php $i++; ?>
                        <?php
                      }
